...
variable "feature_name" {
  description = "Name of the featue."
  type        = string
  default     = ""
}
...
variable "source_repository_ssh" {
  description = "URL of the repository."
  type        = string
}
...
variable "private_repository" {
  description = "Set to true if repo is private"
  type        = bool
  default     = true
}

variable "source_credential_user_name" {
  description = "Authorization user name."
  type        = string
  default     = ""
}
...
# Secret Manager
variable "secret_manager_name_for_repo" {
  type        = string
  default     = "github"
  description = "Secret manager name for repository credentials."
}

variable "use_secret_manager_for_credentials" {
  type        = bool
  default     = true
  description = "If true , credentials are fetched from secret manager"
}

variable "use_arn_for_secret_manager_name" {
  type       = bool
  default    = false
  description = "If true arn of the secret is used to fetch the secret."
}
